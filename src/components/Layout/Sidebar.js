...
const Sidebar = () => {
  ...
  // Define navigation items with their routes - no protection needed
  const tabs = [
    { id: 'overview', label: 'Overview', icon: 'Home', path: '/overview' },
    { id: 'solar', label: 'Solar / PV', icon: 'Sun', path: '/solar' },
    { id: 'genset', label: 'Genset', icon: 'Factory', path: '/genset' },
    { id: 'grid', label: 'Grid', icon: 'Zap', path: '/grid' },
      ...
      <div className="relative z-10 p-6 border-b border-white/20">
        <div className="flex items-center justify-between">
          ...
          >
            ...
            <p className="text-sm text-white/80 mt-1">Cloud Dashboard</p>
          </div>
          <button
